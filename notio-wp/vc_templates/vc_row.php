...
$disable_element = $thb_scroll_to_bottom = $thb_color = $thb_video_bg = $bg_video = $thb_video_bg = $bg_video_overlay = $thb_scroll_bottom_style = '';
$output = $after_output = '';
...
if ( ! empty( $full_height ) ) {
	$css_classes[] = 'vc_row-o-full-height full-height-content';
