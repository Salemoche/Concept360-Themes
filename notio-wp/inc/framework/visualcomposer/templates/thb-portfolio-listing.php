...
function thb_get_portfolio_listing_templates($template_list) {
  ...
  $template_list['portfolio_listing_16'] = array(
  	'name' => esc_html__( 'Portfolio-Listing - Style 16', 'notio' ),
  	'thumbnail' => Thb_Theme_Admin::$thb_theme_directory_uri."assets/img/admin/demos/listing/list-e16.jpg",
  	'cat' => array( 'Portfolio-Listing' ),
  	'sc' => '[vc_row thb_full_width="true" thb_row_padding="true" css=".vc_custom_1541410013207{padding-top: 4vh !important;}"][vc_column][thb_portfolio_grid style="style1" columns="small-12 large-6" true_aspect="true" thb_margins="true" hover_style="hover-style10" title_position="title-topleft" source="size:6|post_type:portfolio"][vc_row_inner thb_row_padding="true" css=".vc_custom_1541416749317{padding-top: 2vh !important;}"][vc_column_inner thb_color="thb-light-column" el_class="text-center"][thb_button_text style="style4" animation="animation fade-in" link="url:http%3A%2F%2Fnewnotio.fuelthemes.net%2Fperfectus%2Fworks%2F|title:Explore%20More%20of%20our%20Work||"][vc_empty_space height="120px"][vc_separator color="custom" accent_color="#171717"][/vc_column_inner][/vc_row_inner][/vc_column][/vc_row]',
  );
