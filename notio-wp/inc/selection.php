...
.subfooter .thb-subfooter-menu li a {
	<?php thb_typeecho($subfootermenu_type); ?>
}
<?php } ?>
...
<?php thb_linkcolorecho($footerlink_color, '.footer.style2'); ?>
<?php thb_linkcolorecho($footerlink_color, '.footer.style1 .social-links'); ?>
<?php } ?>

<?php if ($subfootermenu_color = ot_get_option('subfootermenu_color')) { ?>
<?php thb_linkcolorecho($subfootermenu_color, '.subfooter .thb-subfooter-menu li'); ?>
<?php thb_linkcolorecho($subfootermenu_color, '.subfooter.dark .thb-subfooter-menu li'); ?>
<?php } ?>
...
<?php
	...
	if ($posts->have_posts()) :  while ($posts->have_posts()) : $posts->the_post();
		...
		?>
			...
			/* Hover Style 10 */
			.thb-portfolio .post-<?php echo esc_attr($thb_id); ?>.type-portfolio.hover-style10 .portfolio-link:after {
...
.subfooter {
	<?php thb_spacingecho($subfooter_padding, false, 'padding'); ?>
}
<?php } ?>
/* Extra CSS */
<?php
