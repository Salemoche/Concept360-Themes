...
?>
<div class="row full-height-content full-width-row align-middle" id="customer_login">
	...
	<div class="small-12 medium-6 columns login-section first">
		...
		<p><?php esc_html_e('I am a customer and would like to login.', 'notio'); ?></p>
	...
	<div class="small-12 medium-6 columns login-section second">
		...
		<span class="or"><?php esc_html_e( "OR" ,'notio' ); ?></span>

			<h2><?php esc_html_e( 'Register', 'woocommerce' ); ?></h2>
			<p><?php esc_html_e('Im a new customer and would like to register.', 'notio'); ?></p>
